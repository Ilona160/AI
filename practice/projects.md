...
<div class="content-block" style="background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(10px); border: 1px solid rgba(168, 85, 247, 0.3); padding: 2rem; border-radius: 24px; margin-bottom: 2rem;">
    ...
    <h3 style="color: #f8fafc; margin-bottom: 1rem;">🔬 Аналітичне дослідження сфери ШІ</h3>
    <p style="color: #e2e8f0; line-height: 1.6; margin-bottom: 2rem;">Ви проводите глибокий аналіз конкретної сфери. Дослідження — це не реферат, а пошук відповідей на складні питання.</p>

    <h4 style="color: #f8fafc; margin-bottom: 1rem;">📂 Теми для дослідження:</h4>
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; font-size: 0.95rem; color: #e2e8f0; margin-bottom: 2.5rem;">
    ...
    <div style="margin-bottom: 1.5rem;">
        <p style="font-size: 0.8rem; color: #10b981; font-weight: bold; margin-bottom: 8px; text-transform: uppercase;"># Генерація огляду теми</p>
        <div style="border: 1px solid #10b981; border-radius: 12px; padding: 1.25rem; background: rgba(0, 0, 0, 0.3);">
            <pre style="color: #10b981; font-family: 'Courier New', monospace; font-size: 0.9rem; white-space: pre-wrap; margin: 0; line-height: 1.4;">Дій як науковий аналітик. Дай структурований огляд теми "[ваша тема]" станом на 2024 рік. Включи: 3 реальні кейси з назвами компаній, 3 переваги, 3 ризики та 2 суперечливі питання. Вкажи, де твої знання можуть бути застарілими.</pre>
        </div>
    </div>

    <div style="margin-bottom: 1.5rem;">
        <p style="font-size: 0.8rem; color: #10b981; font-weight: bold; margin-bottom: 8px; text-transform: uppercase;"># Пошук різних точок зору</p>
        <div style="border: 1px solid #10b981; border-radius: 12px; padding: 1.25rem; background: rgba(0, 0, 0, 0.3);">
            <pre style="color: #10b981; font-family: 'Courier New', monospace; font-size: 0.9rem; white-space: pre-wrap; margin: 0; line-height: 1.4;">Наведи аргументи 3-х сторін щодо "[ваша тема]": 1. Оптиміст (переваги), 2. Скептик (заперечення), 3. Прагматик (баланс). Для кожної: 2-3 конкретні аргументи.</pre>
        </div>
    </div>
...
<div class="content-block" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); padding: 1.5rem; border-radius: 20px;">
    <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
        <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
            ...
            <th style="padding: 10px; text-align: left;">Етап</th>
            <th style="padding: 10px; text-align: left;">Результат</th>
        </tr>
        <tr><td style="padding: 10px;">Урок 15</td><td style="padding: 10px;">Вибір теми</td><td style="padding: 10px;">Обраний варіант</td></tr>
        <tr><td style="padding: 10px;">Урок 16</td><td style="padding: 10px;">Планування</td><td style="padding: 10px;">Заповнена Картка</td></tr>
        <tr><td style="padding: 10px;">Урок 17-18</td><td style="padding: 10px;">Захист</td><td style="padding: 10px;">Виступ (100 балів)</td></tr>
    </table>
</div>
